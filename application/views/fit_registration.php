...
<div id="registration-tab">
    <ul>
        <li><a href="#tabs-1">รอลงทะเบียนฟิตเนส</a></li>
        <li><a href="#tabs-2">ลงทะเบียนฟิตเนสแล้ว</a></li>
    </ul>
    <div id="tabs-1">
...
<script>
    ...
    function getRegistrationWaitingList() {
        ...
        $.ajax("getFitnessWaitingList/" + getCurrentDate()).done(function(result) {
    ...
    function getRegistrationReceiveList(mealVal) {
        ...
        $.ajax("getFitnessRegisteredList/" + getCurrentDate()).done(function(result) {

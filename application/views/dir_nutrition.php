...
#coach-physical .date-select-section {
    height: 40px;
    width: auto;
...
#coach-physical .schedule-section {
    height: auto;
...
<script>
    ...
    function loadFitnessSchedule($dateSelector) {
        ...
        $.get("../coach/getNutritionSchedule/" + date).done(function(result) {
            ...
            if (schedule.length === 0) {
                $("<div>").text("*** ไม่มีรายการกายภาพของวันที่เลือก").appendTo($scheduleTable);

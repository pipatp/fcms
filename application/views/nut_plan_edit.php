...
<!--            <td><input type="text" class="form-control input-sm"></input></td>
            <td><input type="text" class="form-control input-sm"></input></td>
            <td><input type="text" class="form-control input-sm"></input></td>-->
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpPlyWgh ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpCalDay ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpMlkUnt ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpMeaUnt ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpFrtUnt ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpVegUnt ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpRceNod ?>"></input></td>
            <td><input type="text" class="form-control input-sm" value="<?php echo $player->NmpLipUnt ?>"></input></td>
        </tr>
        <?php
        }
        ?>

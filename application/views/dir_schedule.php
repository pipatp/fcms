...
<script>
    ...
    function deleteWorklistRow() {
        ...
        $.post("../Administrator/deleteTeamWorklistItem", JSON.stringify(deleteRequest)).done(function() {
    ...
    function loadTeamSchedule($datePicker) {
        ...
        $.get("../Administrator/getTeamSchedule/" + date).done(function(result) {
    ...
    function addWorklistItem() {
        ...
        $.post("../Administrator/addTeamSchedule", JSON.stringify(addRequest)).done(function() {
    ...
    $("#appointment-detail").focusout(function() {
        ...
        if ($commentBox.val() === currentComment) {
            ...
            $.post("../Administrator/updateTeamScheduleDetail", JSON.stringify(updateRequest)).done(function() {
                convertToDiv($section);
            }).fail(function() {
                alert("ไม่สามารถลบข้อมูลได้ โปรดลองอีกครั้งหนึ่ง");
            });

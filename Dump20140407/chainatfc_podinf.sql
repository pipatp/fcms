...
--
-- Table structure for table `podinf`
--

DROP TABLE IF EXISTS `podinf`;
...
CREATE TABLE `podinf` (
  ...
  `PodUsg` varchar(200) default NULL,
  `PodCmt` varchar(500) default NULL,
...
-- Dump completed on 2014-04-07 22:26:16
